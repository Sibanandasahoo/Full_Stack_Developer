	...
	<div
		...
		<form action=InsertFlight method=post>
			<label for=Flight_no>Flight_no :-</label> <input type="text"
				name=Flight_No id=Flight_No /><br> <br> <label for=name>Name
				:-</label> <input type="text" name=name id=name /><br> <br> <label
				for=from>From :-</label> <input type="text" name=from id=from /><br>
			<br> <label for=to>To :-</label> <input type="text" name=to
				id=to /><br> <br> <label for=departure>Departure
				:-</label> <input type="date" name=departure id=departure /><br> <br>
			<label for=time>Time :-</label> <input type="time" name=time id=time /><br>
			<br> <label for=price>Price :-</label> <input type="text"
				name=price id=price /><br> <br> <label for=Avl_Seats>Avl_Seats
				:-</label> <input type="text" name=Avl_Seats id=Avl_Seats /><br> <br>
