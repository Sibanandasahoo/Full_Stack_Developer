...
<body style="background-color: #73C2FB;">
	...
	<div
		...
		<form action=UserRegistration method=post>
			...
			<input type="password" name=password id=pass /><br> <br> <label
			...
			<br> <label for=phno>Phone No. :-</label> <input type="text"
				...
				No. :-</label> <input type="text" name=adno id=adno /><br> <br> <a
				href="Flyaway.jsp">| Home Page |</a><input type=submit value=submit />
			<input type=reset />
